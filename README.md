if IY_LOADED and not _G.IY_DEBUG == true then
	-- error("MrAndi Admin is already running!",0)
	return
end
...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'MrAndi Admin is waiting for the game to load'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "MrAndi Admin FE v"..ver
...
Logo.Image = "rbxassetid://11259936495"
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- MrAndi Admin Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the MrAndi Admin support server.'}
...
CMDs[#CMDs + 1] = {NAME = 'keepiy', DESC = 'Auto execute MrAndi Admin when you teleport through servers'}
